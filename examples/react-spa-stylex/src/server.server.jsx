...
export function createStylexSpaServer({ dist = defaultDistDir } = {}) {
  return http.createServer((request, response) => {
    void handleStylexSpaRequest({ dist, request, response }).catch((error) => {
...
export async function handleStylexSpaRequest({
  dist = defaultDistDir,
  request,
  response,
}) {
...
const server = createStylexSpaServer();
