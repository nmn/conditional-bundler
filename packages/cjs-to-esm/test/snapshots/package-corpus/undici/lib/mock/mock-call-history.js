...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/mock/mock-call-history.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/mock/mock-call-history.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0::lib/mock/mock-call-history.js::NODE_ENV=production", __cjs_default__);
}
