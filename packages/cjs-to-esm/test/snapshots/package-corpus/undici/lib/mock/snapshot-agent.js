import __cjs_dep_0 from "../dispatcher/agent";
import __cjs_dep_1 from "./mock-agent";
import __cjs_dep_2 from "./snapshot-recorder";
import __cjs_dep_3 from "../core/errors";
import __cjs_dep_4 from "../core/util";
import __cjs_dep_5 from "./snapshot-utils";
...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/mock/snapshot-agent.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/mock/snapshot-agent.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0::lib/mock/snapshot-agent.js::NODE_ENV=production", __cjs_default__);
}
