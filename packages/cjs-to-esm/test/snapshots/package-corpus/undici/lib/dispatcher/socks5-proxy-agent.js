import * as __cjs_dep_0 from "node:url";
import __cjs_dep_1 from "./dispatcher-base";
import __cjs_dep_2 from "../core/errors";
import __cjs_dep_3 from "../core/socks5-client";
import __cjs_dep_4 from "../core/symbols";
import __cjs_dep_5 from "./pool";
import __cjs_dep_6 from "../core/connect";
import * as __cjs_dep_7 from "node:util";
import * as __cjs_dep_8 from "node:tls";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "node:tls":
      return __cjs_dep_8;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0/lib/dispatcher/socks5-proxy-agent.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0/lib/dispatcher/socks5-proxy-agent.js");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0/lib/dispatcher/socks5-proxy-agent.js", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0/lib/dispatcher/socks5-proxy-agent.js", __cjs_default__);
}
