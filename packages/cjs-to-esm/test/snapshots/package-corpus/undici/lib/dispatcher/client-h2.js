...
import __cjs_dep_2 from "../core/util.js";
import __cjs_dep_3 from "../core/errors.js";
import __cjs_dep_4 from "../core/symbols.js";
import __cjs_dep_5 from "../core/diagnostics.js";
import * as __cjs_dep_6 from "node:http2";
import __cjs_dep_7 from "../web/fetch/body.js";
...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/dispatcher/client-h2.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/dispatcher/client-h2.js::NODE_ENV=production", __cjs_exports__);
  ((module, exports, require, process, __filename, __dirname) => {
    ...
    function openStream(client, request, session, abort, headers, options) {
      try {
        ...
        const wrappedErr = new InformationalError(err.message, {
          cause: err
        });
        session[kError] = wrappedErr;
  ...
  __cjs_cache__.set("undici@8.7.0::lib/dispatcher/client-h2.js::NODE_ENV=production", __cjs_default__);
}
