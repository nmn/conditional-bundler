...
import __cjs_dep_1 from "../fetch";
import __cjs_dep_2 from "../webidl";
import __cjs_dep_3 from "./eventsource-stream";
import __cjs_dep_4 from "../fetch/data-url";
import __cjs_dep_5 from "../websocket/events";
import __cjs_dep_6 from "../fetch/response";
import __cjs_dep_7 from "../../core/util";
import __cjs_dep_8 from "../fetch/util";
import __cjs_dep_9 from "./util";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "./util":
      return __cjs_dep_9;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0::lib/web/eventsource/eventsource.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/eventsource/eventsource.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/eventsource/eventsource.js::NODE_ENV=production", __cjs_exports__);
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "undici@8.7.0::lib/web/eventsource/eventsource.js", "undici@8.7.0::lib/web/eventsource");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/eventsource/eventsource.js::NODE_ENV=production", __cjs_default__);
}
