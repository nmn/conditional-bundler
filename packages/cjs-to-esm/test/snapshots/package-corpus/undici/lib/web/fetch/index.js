import __cjs_dep_0 from "./response";
import __cjs_dep_1 from "./headers";
import __cjs_dep_2 from "./request";
import * as __cjs_dep_3 from "node:zlib";
import __cjs_dep_4 from "./util";
import * as __cjs_dep_5 from "node:assert";
import __cjs_dep_6 from "./body";
import __cjs_dep_7 from "./constants";
import * as __cjs_dep_8 from "node:events";
import * as __cjs_dep_9 from "node:stream";
import __cjs_dep_10 from "../../core/util";
import __cjs_dep_11 from "./data-url";
import __cjs_dep_12 from "../../global";
import __cjs_dep_13 from "../webidl";
import * as __cjs_dep_14 from "node:http";
import __cjs_dep_15 from "../subresource-integrity/subresource-integrity";
import __cjs_dep_16 from "../infra";
import * as __cjs_dep_17 from "node:buffer";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "node:http":
      return __cjs_dep_14;
    case "../subresource-integrity/subresource-integrity":
      return __cjs_dep_15;
    case "../infra":
      return __cjs_dep_16;
    case "node:buffer":
      return __cjs_dep_17;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0::lib/web/fetch/index.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/fetch/index.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/fetch/index.js::NODE_ENV=production", __cjs_exports__);
  ((module, exports, require, process, __filename, __dirname) => {
    ...
    const {
      bytesMatch
    } = require('../subresource-integrity/subresource-integrity');
    const {
      isomorphicEncode
    } = require('../infra');
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "undici@8.7.0::lib/web/fetch/index.js", "undici@8.7.0::lib/web/fetch");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/fetch/index.js::NODE_ENV=production", __cjs_default__);
}
