import * as __cjs_dep_0 from "node:events";
import __cjs_dep_1 from "../../fetch/util";
import __cjs_dep_2 from "../constants";
import __cjs_dep_3 from "../../webidl";
import __cjs_dep_4 from "../util";
import __cjs_dep_5 from "../connection";
import __cjs_dep_6 from "../../../core/diagnostics";
import __cjs_dep_7 from "../frame";
import __cjs_dep_8 from "../receiver";
import __cjs_dep_9 from "./websocketerror";
import __cjs_dep_10 from "../../../core/util";
import __cjs_dep_11 from "../../../encoding";
...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/websocket/stream/websocketstream.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/websocket/stream/websocketstream.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0::lib/web/websocket/stream/websocketstream.js::NODE_ENV=production", __cjs_default__);
}
