...
const _isValidLastEventId = _cjs_default["isValidLastEventId"];
export { _isValidLastEventId as isValidLastEventId };
const _isASCIINumber = _cjs_default["isASCIINumber"];
export { _isASCIINumber as isASCIINumber };
const _createPotentialCORSRequest = _cjs_default["createPotentialCORSRequest"];
export { _createPotentialCORSRequest as createPotentialCORSRequest };
