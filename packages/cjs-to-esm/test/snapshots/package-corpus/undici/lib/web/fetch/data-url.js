...
const _dataURLProcessor = _cjs_default["dataURLProcessor"];
export { _dataURLProcessor as dataURLProcessor };
const _URLSerializer = _cjs_default["URLSerializer"];
export { _URLSerializer as URLSerializer };
const _stringPercentDecode = _cjs_default["stringPercentDecode"];
export { _stringPercentDecode as stringPercentDecode };
const _parseMIMEType = _cjs_default["parseMIMEType"];
export { _parseMIMEType as parseMIMEType };
const _collectAnHTTPQuotedString = _cjs_default["collectAnHTTPQuotedString"];
export { _collectAnHTTPQuotedString as collectAnHTTPQuotedString };
const _serializeAMimeType = _cjs_default["serializeAMimeType"];
export { _serializeAMimeType as serializeAMimeType };
const _removeHTTPWhitespace = _cjs_default["removeHTTPWhitespace"];
export { _removeHTTPWhitespace as removeHTTPWhitespace };
const _minimizeSupportedMimeType = _cjs_default["minimizeSupportedMimeType"];
export { _minimizeSupportedMimeType as minimizeSupportedMimeType };
const _HTTP_TOKEN_CODEPOINTS = _cjs_default["HTTP_TOKEN_CODEPOINTS"];
export { _HTTP_TOKEN_CODEPOINTS as HTTP_TOKEN_CODEPOINTS };
