import __cjs_dep_0 from "./body";
import __cjs_dep_1 from "./headers";
import __cjs_dep_2 from "../../core/util";
import * as __cjs_dep_3 from "node:util";
import __cjs_dep_4 from "./util";
import __cjs_dep_5 from "./constants";
import __cjs_dep_6 from "../webidl";
import __cjs_dep_7 from "./data-url";
import __cjs_dep_8 from "../../core/symbols";
import * as __cjs_dep_9 from "node:assert";
import * as __cjs_dep_10 from "node:events";
...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/fetch/request.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/fetch/request.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0::lib/web/fetch/request.js::NODE_ENV=production", __cjs_default__);
}
