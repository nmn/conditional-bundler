...
import __cjs_dep_1 from "../../util/runtime-features.js";
import * as __cjs_dep_2 from "node:crypto";
...
function __cjs_require__(request) {
  switch (request) {
    case "node:assert":
      return __cjs_dep_0;
    case "../../util/runtime-features.js":
      return __cjs_dep_1;
    case "node:crypto":
      return __cjs_dep_2;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0::lib/web/subresource-integrity/subresource-integrity.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/subresource-integrity/subresource-integrity.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/subresource-integrity/subresource-integrity.js::NODE_ENV=production", __cjs_exports__);
  ((module, exports, require, process, __filename, __dirname) => {
    ...
    const {
      runtimeFeatures
    } = require('../../util/runtime-features.js');
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "undici@8.7.0::lib/web/subresource-integrity/subresource-integrity.js", "undici@8.7.0::lib/web/subresource-integrity");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/subresource-integrity/subresource-integrity.js::NODE_ENV=production", __cjs_default__);
}
