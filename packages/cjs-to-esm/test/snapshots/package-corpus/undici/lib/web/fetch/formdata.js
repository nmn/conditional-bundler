...
class FormData {
  ...
  set(name, value, filename = undefined) {
    ...
    const idx = this.#state.findIndex(entry => entry.name === name);
    if (idx !== -1) {
      this.#state = [...this.#state.slice(0, idx), entry, ...this.#state.slice(idx + 1).filter(entry => entry.name !== name)];
    } else {
...
const _FormData = _cjs_default["FormData"];
export { _FormData as FormData };
const _makeEntry = _cjs_default["makeEntry"];
export { _makeEntry as makeEntry };
const _setFormDataState = _cjs_default["setFormDataState"];
export { _setFormDataState as setFormDataState };
const _getFormDataBoundary = _cjs_default["getFormDataBoundary"];
export { _getFormDataBoundary as getFormDataBoundary };
