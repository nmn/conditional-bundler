...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0/lib/web/websocket/connection.js");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0/lib/web/websocket/connection.js", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0/lib/web/websocket/connection.js", __cjs_default__);
}
