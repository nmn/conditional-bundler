import __cjs_dep_0 from "./constants";
import __cjs_dep_1 from "./util";
import __cjs_dep_2 from "../fetch/request";
import __cjs_dep_3 from "../fetch/index";
import __cjs_dep_4 from "../fetch/headers";
import __cjs_dep_5 from "../fetch/util";
import __cjs_dep_6 from "./frame";
import * as __cjs_dep_7 from "node:assert";
import __cjs_dep_8 from "../../util/runtime-features";
import * as __cjs_dep_9 from "node:crypto";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "node:assert":
      return __cjs_dep_7;
    case "../../util/runtime-features":
      return __cjs_dep_8;
    case "node:crypto":
      return __cjs_dep_9;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0::lib/web/websocket/connection.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/web/websocket/connection.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/websocket/connection.js::NODE_ENV=production", __cjs_exports__);
  ((module, exports, require, process, __filename, __dirname) => {
    ...
    const {
      runtimeFeatures
    } = require('../../util/runtime-features');
    const crypto = runtimeFeatures.has('crypto') ? require('node:crypto') : null;
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "undici@8.7.0::lib/web/websocket/connection.js", "undici@8.7.0::lib/web/websocket");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/web/websocket/connection.js::NODE_ENV=production", __cjs_default__);
}
