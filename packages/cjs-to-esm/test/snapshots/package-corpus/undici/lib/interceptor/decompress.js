import * as __cjs_dep_0 from "node:zlib";
import * as __cjs_dep_1 from "node:stream";
import __cjs_dep_2 from "../handler/decorator-handler";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "node:stream":
      return __cjs_dep_1;
    case "../handler/decorator-handler":
      return __cjs_dep_2;
    default:
      throw new Error("Cannot require " + request + " from undici@8.7.0::lib/interceptor/decompress.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/interceptor/decompress.js::env=snapshot::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/interceptor/decompress.js::env=snapshot::NODE_ENV=production", __cjs_exports__);
  ((module, exports, require, process, __filename, __dirname) => {
    ...
    class DecompressHandler extends DecoratorHandler {
      ...
      #skipErrorResponses;
      constructor(handler, {
        skipStatusCodes = defaultSkipStatusCodes,
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "undici@8.7.0::lib/interceptor/decompress.js", "undici@8.7.0::lib/interceptor");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/interceptor/decompress.js::env=snapshot::NODE_ENV=production", __cjs_default__);
}
