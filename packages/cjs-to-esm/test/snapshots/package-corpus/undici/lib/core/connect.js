import * as __cjs_dep_0 from "node:net";
import * as __cjs_dep_1 from "node:assert";
import __cjs_dep_2 from "./util";
import __cjs_dep_3 from "./errors";
import * as __cjs_dep_4 from "node:tls";
...
let __cjs_default__ = __cjs_cache__.get("undici@8.7.0::lib/core/connect.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("undici@8.7.0::lib/core/connect.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("undici@8.7.0::lib/core/connect.js::NODE_ENV=production", __cjs_default__);
}
