...
function buildAddressBuffer(type, addressBuffer, port) {
  ...
  return Buffer.concat([Buffer.from([type]), addressBuffer, portBuffer]);
}
...
const _parseAddress = _cjs_default["parseAddress"];
export { _parseAddress as parseAddress };
const _parseIPv = _cjs_default["parseIPv6"];
export { _parseIPv as parseIPv6 };
const _buildAddressBuffer = _cjs_default["buildAddressBuffer"];
export { _buildAddressBuffer as buildAddressBuffer };
const _parseResponseAddress = _cjs_default["parseResponseAddress"];
export { _parseResponseAddress as parseResponseAddress };
const _createReplyError = _cjs_default["createReplyError"];
export { _createReplyError as createReplyError };
