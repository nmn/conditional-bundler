...
const _f2 = DESCRIPTORS && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O, Properties) {
  anObject(O);
  ...
  var index = 0;
  var key;
  while (length > index) _f(O, key = keys[index++], props[key]);
  return O;
};
export { _f2 as f };
const _cjs_default = {
