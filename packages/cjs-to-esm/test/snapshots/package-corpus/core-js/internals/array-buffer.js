...
var getInternalArrayBufferState = _getterFor(ARRAY_BUFFER);
var getInternalDataViewState = _getterFor(DATA_VIEW);
...
var packIEEE754 = _pack;
var unpackIEEE754 = _unpack;
...
const _ArrayBuffer = _cjs_default["ArrayBuffer"];
export { _ArrayBuffer as ArrayBuffer };
const _DataView = _cjs_default["DataView"];
export { _DataView as DataView };
