...
import arraySort from "../internals/array-sort";
...
var getInternalParamsState = _getterFor(URL_SEARCH_PARAMS);
var getInternalIteratorState = _getterFor(URL_SEARCH_PARAMS_ITERATOR);
...
const _URLSearchParams = _cjs_default["URLSearchParams"];
export { _URLSearchParams as URLSearchParams };
const _getState = _cjs_default["getState"];
export { _getState as getState };
