...
import createArrayFromList from "../internals/array-slice";
import { WeakMap as _WeakMap, get as _get, has as _has, set as _set } from "../internals/weak-map-helpers";
import cooked from "../internals/string-cooked";
import parse from "../internals/string-parse";
import whitespaces from "../internals/whitespaces";
var defineProperty = _f;
var DedentMap = new _WeakMap();
var weakMapGet = _get;
var weakMapHas = _has;
var weakMapSet = _set;
var $Array = Array;
