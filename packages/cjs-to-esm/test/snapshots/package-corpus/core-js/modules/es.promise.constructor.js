...
import { getterFor as _getterFor, set as _set2 } from "../internals/internal-state";
import NativePromiseConstructor from "../internals/promise-native-constructor";
import { CONSTRUCTOR as _CONSTRUCTOR, REJECTION_EVENT as _REJECTION_EVENT, SUBCLASSING as _SUBCLASSING } from "../internals/promise-constructor-detection";
import { f as _f } from "../internals/new-promise-capability";
var task = _set;
var PROMISE = 'Promise';
var FORCED_PROMISE_CONSTRUCTOR = _CONSTRUCTOR;
var NATIVE_PROMISE_REJECTION_EVENT = _REJECTION_EVENT;
var NATIVE_PROMISE_SUBCLASSING = _SUBCLASSING;
var getInternalPromiseState = _getterFor(PROMISE);
var setInternalState = _set2;
...
if (FORCED_PROMISE_CONSTRUCTOR) {
  ...
  _f = newPromiseCapability = function (C) {
