import __cjs_dep_0 from "readable-stream";
import __cjs_dep_1 from "async/forEach";
import __cjs_dep_2 from "triple-beam";
import __cjs_dep_3 from "is-stream";
import __cjs_dep_4 from "./exception-handler";
import __cjs_dep_5 from "./rejection-handler";
import __cjs_dep_6 from "winston-transport/legacy";
import __cjs_dep_7 from "./profiler";
import __cjs_dep_8 from "./common";
import __cjs_dep_9 from "./config";
import __cjs_dep_10 from "logform/json";
...
function __cjs_require__(request) {
  switch (request) {
    ...
    case "./exception-handler":
      return __cjs_dep_4;
    case "./rejection-handler":
      return __cjs_dep_5;
    case "winston-transport/legacy":
      return __cjs_dep_6;
    case "./profiler":
      return __cjs_dep_7;
    case "./common":
    ...
    case "logform/json":
      return __cjs_dep_10;
    default:
      throw new Error("Cannot require " + request + " from winston@3.19.0::lib/winston/logger.js");
  }
}
const __cjs_cache__ = globalThis.__BUNDLER_CJS_CACHE__ ??= new Map();
let __cjs_default__ = __cjs_cache__.get("winston@3.19.0::lib/winston/logger.js::env=snapshot::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("winston@3.19.0::lib/winston/logger.js::env=snapshot::NODE_ENV=production", __cjs_exports__);
  ...
  })(__cjs_module__, __cjs_exports__, __cjs_require__, __cjs_process__, "winston@3.19.0::lib/winston/logger.js", "winston@3.19.0::lib/winston");
  __cjs_default__ = __cjs_module__.exports;
  __cjs_cache__.set("winston@3.19.0::lib/winston/logger.js::env=snapshot::NODE_ENV=production", __cjs_default__);
}
