...
let __cjs_default__ = __cjs_cache__.get("winston@3.19.0::lib/winston/profiler.js::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("winston@3.19.0::lib/winston/profiler.js::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("winston@3.19.0::lib/winston/profiler.js::NODE_ENV=production", __cjs_default__);
}
