...
let __cjs_default__ = __cjs_cache__.get("@statsig/client-core@3.33.3::src/$_StatsigGlobal.js::env=snapshot::NODE_ENV=production");
if (!__cjs_default__) {
  const __cjs_module__ = {
    exports: {}
  };
  const __cjs_exports__ = __cjs_module__.exports;
  __cjs_cache__.set("@statsig/client-core@3.33.3::src/$_StatsigGlobal.js::env=snapshot::NODE_ENV=production", __cjs_exports__);
  ...
  __cjs_cache__.set("@statsig/client-core@3.33.3::src/$_StatsigGlobal.js::env=snapshot::NODE_ENV=production", __cjs_default__);
}
