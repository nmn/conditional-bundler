...
export type IRHeader = Pick<FileIR, "id" | "prefix" | "contentHash" | "imports" | "reexportsNamed" | "exportStars" | "exportsLocal" | "flags" | "dynamicImports" | "conditionalImports" | "discoveredEntrypoints" | "importRanges" | "exportRanges" | "pkg"> & {
    envs: string[];
    codeByEnv: Record<string, string>;
    mapByEnv: Record<string, string>;
};
